        ...
        <div class="order-session-bar">
            ...
            {if $username == null && !$supressWelcome}
                <div class="order-session-actions">
                    ...
                    <a href="index.php?page=purchasesubscription" class="btn btn-outline-primary order-register-button">
                        Subscriptions
                    </a>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js"
        onload="document.documentElement.setAttribute('data-bootstrap-js-cdn', 'loaded')"
        onerror="document.documentElement.setAttribute('data-bootstrap-js-cdn', 'error')"></script>
